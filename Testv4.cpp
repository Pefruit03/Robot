...
int main() 
{
	...
	while(H[0].x != 400 && H[0].y != 150)
	{
		if (ismouseclick(WM_LBUTTONDOWN))
		{
			...
			delay(50);
			cleardevice();
			if (H[0].x >= 398 && H[0].x <= 402 && H[0].y >= 148 && H[0].y <= 152)
			{
				H[0].x = 400, H[0].y = 150;
	...
	while(LH[0].x != 300 && LH[0].y != 250)
	{
		if (ismouseclick(WM_LBUTTONDOWN))
		{
			...
			delay(50);
			cleardevice();
			if (LH[0].x >= 298 && LH[0].x <= 302 && LH[0].y >= 248 && LH[0].y <= 252)
			{
				LH[0].x = 300, LH[0].y = 250;
				clearmouseclick(WM_MOUSEMOVE);
				clearmouseclick(WM_LBUTTONDOWN);
	...
	while(RH[0].x != 550 && RH[0].y != 250)
	{
		if (ismouseclick(WM_LBUTTONDOWN))
		{
			getmouseclick(WM_MOUSEMOVE, RH[0].x, RH[0].y);
			drawBody();
			drawHead(H);
			drawLeftHand(LH);
			drawRightHand(RH);
			delay(50);
			cleardevice();
			if (RH[0].x >= 548 && LH[0].x <= 552 && RH[0].y >= 248 && LH[0].y <= 252)
			{
				RH[0].x = 550, RH[0].y = 250;
				clearmouseclick(WM_MOUSEMOVE);
				clearmouseclick(WM_LBUTTONDOWN);
	...
	while(LL[0].x != 400 && LL[0].y != 370)
	{
		if (ismouseclick(WM_LBUTTONDOWN))
		{
			getmouseclick(WM_MOUSEMOVE, LL[0].x, LL[0].y);
			drawBody();
			drawHead(H);
			drawLeftHand(LH);
			drawRightHand(RH);
			...
			delay(50);
			cleardevice();
			if (LL[0].x >= 398 && LL[0].x <= 402 && LL[0].y >= 368 && LL[0].y <= 372)
			{
				LL[0].x = 400, LL[0].y = 370;
				clearmouseclick(WM_MOUSEMOVE);
				clearmouseclick(WM_LBUTTONDOWN);
	...
	while(RL[0].x != 500 && RL[0].y != 370)
	{
		if (ismouseclick(WM_LBUTTONDOWN))
		{
			getmouseclick(WM_MOUSEMOVE, RL[0].x, RL[0].y);
			drawBody();
			drawHead(H);
			drawLeftHand(LH);
			drawRightHand(RH);
			...
			delay(50);
			cleardevice();
			if (RL[0].x >= 498 && RL[0].x <= 502 && RL[0].y >= 368 && RL[0].y <= 372)
			{
				RL[0].x = 500, RL[0].y = 370;
				clearmouseclick(WM_MOUSEMOVE);
				clearmouseclick(WM_LBUTTONDOWN);
